  ...
  return (
    ...
    className='app-container py-16 bg-gradient-to-br from-dark to-gray-900 rounded-3xl text-white'>
      <div className='text-center mb-12'>
        ...
        <h2 className='section-header'>How AI 
          <span className='gradient-text'> is Transforming Our World</span> 
          </h2>
          <p className='section-description text-gray-300'>Discover the positive impact of AI across various sectors and industries.</p>
      </div>
