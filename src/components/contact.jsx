    ...
    <section id='contact' className='app-container py-16'>
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        <div>
          ...
          <h2 className='section-header'>Ready to
            <span className='gradient-text'> Transform </span>
            Your Buisness with AI?
          </h2>
          <p className='section-describtion'>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8">
          <form action="">
            <div className="space-y-6">
              <div>
                <label htmlFor="" className="form-input-label">Full Name</label>
              ...
              <div>
                <label htmlFor="" className="form-input-label">Subject</label>
                <input type="text"className="form-input" />
              </div>
              <div>
                <label htmlFor="" className="form-input-label">Message</label>
                <textarea type="text"className="form-input" rows={4}/>
              </div>
            </div>
